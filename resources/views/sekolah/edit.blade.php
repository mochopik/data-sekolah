                ...
                <div class="card-body">
                    <form action="{{ route('sekolah.update', $sekolah->id) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{ $sekolah->nama }}" name="nama" class="form-control" placeholder="Nama"> 
                            </div>
                        </div> 
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{ $sekolah->alamat}}" name="alamat" class="form-control" placeholder="Alamat">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="kelurahan" class="col-md-4 col-form-label text-md-right">Kelurahan:</label> 
                            <div class="col-md-6">
                                <input type="text" value="{{ $sekolah->kelurahan}}" name="kelurahan" class="form-control" placeholder="Kelurahan">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="kecamatan" class="col-md-4 col-form-label text-md-right">Kecamatan:</label> 
                            <div class="col-md-6">
                                <input type="text" value="{{ $sekolah->kecamatan}}" name="kecamatan" class="form-control" placeholder="Kecamatan">
                            </div>
                        </div> 
